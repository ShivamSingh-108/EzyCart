    ...
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start mt-5">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYweJw5Q5QK2VwW4mGql0zqkTPliK1JL9mNQ&s"
            style={{ width: "150px", objectFit: "contain" }}
            alt=""
          />
        </div>
        <div className="flex items-start mt-4">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9Ev-r4iIFRk-iHzTQjEEMhNNSMaPU1Mbq19QQwXgo36caszUv0eHET3KD6PCHKrtcM1Y&usqp=CAU"
            style={{ width: "150px", objectFit: "contain" }}
            alt=""
          />
        </div>
